		...
		methods: {
			enviar() {
				window.location.replace(
					'https://api.whatsapp.com/send?phone=5581998921993&text=Dale!!,%20me%20recomenda%20um%20' +
						this.typeSelected +
						'%20de%20' +
						this.genderSelected +
						'%20' +
						this.nacionalitySelected +
						'.%20AGORA!!',
				);
			},
		},
...
<style lang="scss">
	...
	@font-face {
		font-family: indie;
		src: local('../../assets/fonts/Indie.otf');
	}
